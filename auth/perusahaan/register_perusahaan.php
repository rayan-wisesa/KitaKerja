...
<div class="card">
  <div class="card-body">
    ...
    <!-- /Logo -->
    <form class="mb-3 needs-validation" novalidate action="register_perusahaan_process.php" method="POST">
      <div class="mb-3">
    ...
    <p class="text-center">
      <span>Sudah memiliki akun?</span><a href="login_perusahaan.php"><span> Masuk</span></a>
    </p>
  </div>
</div>
